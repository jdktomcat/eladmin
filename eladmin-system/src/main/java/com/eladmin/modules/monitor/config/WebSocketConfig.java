package com.eladmin.modules.monitor.config;

import com.eladmin.modules.monitor.domain.LogMessage;
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        if(log!=null){
                            // 格式化异常堆栈信息
                            if("ERROR".equals(log.getLevel()) && "com.eladmin.common.exception.handler.GlobalExceptionHandler".equals(log.getClassName())){
